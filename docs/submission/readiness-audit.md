...
- 3:2 thumbnail: Devpost's direct upload API accepted a 600×400 Meaning Loss Reveal derivative on 2026-07-19 and returned `https://d112y698adiu2z.cloudfront.net/photos/production/software_thumbnail_photos/004/938/209/datas/medium.jpg`; the editor subsequently showed the thumbnail as present
- Gallery: the two refreshed 1440×960 product screenshots were uploaded manually on 2026-07-20; the public project page exposes a three-item media carousel including the existing thumbnail
- Demo video: the final 2:22 English MP4 is public on YouTube at `https://www.youtube.com/watch?v=Nfj_JkcTDVc` and linked from Devpost; English SRT captions are prepared locally but still need Studio upload confirmation
...
| Under-three-minute public video | Public 2:23 YouTube video with English narration, chapters, upload copy, and prepared English SRT captions | Complete for the public video; caption upload remains to be confirmed in Studio |
...
| 3:2 thumbnail | Devpost direct upload returned a production CDN URL and the editor showed the image as present | Complete on draft |
| Product gallery | Two current 1440×960 Meaning Loss Reveal images were uploaded and the public project page exposes a three-item media carousel | Complete on draft |
...
3. Upload the prepared English SRT captions in YouTube Studio and confirm they are public.
